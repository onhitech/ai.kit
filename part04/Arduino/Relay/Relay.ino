...
const char* ssid = "U+Net6D73";
const char* password = "6000051103";
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/L\">here</a> RELAY1 OFF.<br>");
            client.print("Click <a href=\"/H\">here</a> RELAY1 ON.<br>");
           
 
            client.print("Click <a href=\"/I\">here</a> RELAY2 OFF.<br>");
            client.print("Click <a href=\"/J\">here</a> RELAY2 ON.<br>");
